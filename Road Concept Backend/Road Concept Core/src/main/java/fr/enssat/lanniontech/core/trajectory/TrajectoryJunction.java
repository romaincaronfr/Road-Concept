...
public class TrajectoryJunction {
    ...
    public TrajectoryJunction(Trajectory source, Trajectory destination, double sourcePos, double destinationPos) {
        this.source = source;
    ...
    public static TrajectoryJunction computeJunction(SimpleTrajectory source, SimpleTrajectory destination) {
        ...
        if (source.getpF().cross(destination.getpF())) {
            double Ps[] = source.getpF().getInterPos(destination.getpF(), source.getWidth(), destination.getWidth());
